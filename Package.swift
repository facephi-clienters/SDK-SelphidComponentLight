...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "git@github.com:facephi-clienters/selphidnoml-framework.git", branch: "feat/ARM64_SIM"),
        .package(url: "git@github.com:facephi-clienters/SDK-CorePackage-SPM.git", from: "1.1.5"),
    ],
    targets: [
